...
import { Cpu, HardDrive, Zap, ArrowRight, RefreshCw, Loader2, LayoutDashboard } from 'lucide-react';
  ...
  return (
    <div className="page-shell space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 stagger">
        ...
        <StatCard icon={<LayoutDashboard size={20} />} label={t('dashboard.backend')} value={backendOnline ? t('dashboard.online') : t('dashboard.offline')} color={backendOnline ? 'success' : 'danger'} subtitle={system?.version ? `v${system.version}` : undefined} />
      </div>
